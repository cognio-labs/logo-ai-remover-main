...
export const CREATIVE_SUITE_ASSETS: ProductCardItem[] = [
  ...
  {
    id: "ecommerce-studio",
    title: "AI E-Commerce Model Studio",
    link: "/background-remover",
    thumbnail: "/creative-suite/fashion_ecommerce_model.jpg",
    badge: "Fashion Grade",
    category: "Commercial Studio",
    description: "Editorial fabric micro-weave preservation and catalog-ready studio lighting adjustments.",
  },
  {
    id: "anime-remaster",
    title: "Anime & Cel-Shading 4K Remaster",
    link: "/upscale",
    thumbnail: "/creative-suite/anime_neural_remaster.jpg",
    badge: "Vector Stroke",
    category: "Illustration & Anime",
    description: "Clean edge anti-aliasing and vibrant color gradation without ring artifacts.",
  },
  {
    id: "macro-jewelry",
